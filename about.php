...
<main class="container py-5">
  <div class="row g-4 align-items-center mb-4">
    <div class="col-lg-6">
      ...
      <h1 class="fw-bold mb-3">نسخه جدید، کامل‌تر و حرفه‌ای‌تر</h1>
      <p class="text-secondary">GameZone یک پروژه ساده ولی تمیز برای معرفی بازی‌ها و محصولات گیمینگ است که با Bootstrap بازطراحی شده و شامل ثبت‌نام، ورود، خروج و پنل مدیریت کامل می‌شود.</p>
  ...
  <div class="card bg-black text-light panel-card">
    <div class="card-body">
      ...
      <div class="row g-3">
        ...
        <div class="col-md-4"><div class="p-3 border rounded-3 border-secondary-subtle h-100"><i class="bi bi-grid text-info"></i> کاتالوگ جستجوشونده</div></div>
      </div>
    </div>
  </div>
</main>
