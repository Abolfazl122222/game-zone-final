...
$games = [
    'rdr2' => [
        ...
        'cover' => 'images/rdr2.jpg',
        'short_description' => 'داستان Red Dead Redemption 2 در سال ۱۸۹۹ و در غرب وحشی جریان دارد. RDR2 در واقع پیش درآمدی بر داستان بازی اول است و زندگی آرتور مورگان را شرح می‌دهد.',
        'genre' => 'اکشن | ماجراجویی | وسترن',
        'rating' => '9.8/10',
        'story' => [
        ...
        'gallery' => [
            'images/RDR2Screenshot.jpg',
            'images/RDR2Screenshot2.jpg',
        ],
        'video_link' => '#',
    ],
    'gtavi' => [
        ...
        'short_description' => 'یک بازی جهان‌باز با داستانی جذاب و گرافیکی فوق‌العاده که در شهر Los Santos جریان دارد.',
        'genre' => 'اکشن | جهان باز',
        'rating' => '9.5/10',
        'story' => [
            'GTA VI جدیدترین نسخه از سری محبوب Grand Theft Auto است که در شهری با گرافیک نسل جدید جریان دارد. این بازی یک تجربه جهان‌باز کامل با مأموریت‌های داستانی، رانندگی، تیراندازی و آزادی عمل گسترده ارائه می‌دهد.',
        ],
        'features' => [],
        'gallery' => [
            'images/screengta2.jpg',
            'images/screengta.jpg',
        ],
        'video_link' => '#',
    ],
    'gow' => [
        'title' => 'God of War',
        'cover' => 'images/godofwar.jpg',
        'short_description' => 'کریتوس و پسرش در سفری اسطوره‌ای میان دنیای خدایان نورس؛ اکشن، احساس و داستان عمیق.',
        'genre' => 'اکشن | اسطوره‌ای',
        'rating' => '9.7/10',
        'story' => [
    ...
    'fc25' => [
        'title' => 'FC 25',
        'cover' => 'images/fifa25.jpg',
        'short_description' => 'جدیدترین نسخه از بازی فوتبال محبوب با گیم‌پلی بهبود یافته و گرافیکی واقعی‌تر از همیشه.',
        'genre' => 'ورزشی',
        'rating' => '9.1/10',
        'story' => [
        ...
        'gallery' => [
            'images/fc25screen1.jpg',
            'images/eafc25_09_2.jpg',
        ],
        'video_link' => '#',
    ],
    'last2' => [
        'title' => 'The Last of Us Part II',
        'cover' => 'images/the lastofus.jpg',
        'short_description' => 'داستان بازی The Last of Us در سال ۲۰۳۳ و بیست سال بعد از یک شیوع قارچی که نزدیک به ۶۰ درصد جمعیت دنیا را آلوده کرد، جریان دارد.',
        'genre' => 'اکشن | بقا | داستان‌محور',
        'rating' => '9.6/10',
        'story' => [
    ...
    'ghost' => [
        ...
        'cover' => 'images/1.jpg',
        'short_description' => 'داستان بازی Ghost of Tsushima در سال 1274 جریان دارد که مغول‌ها به رهبری کوتان خان، نوه چنگیز خان، به سوشیمای ژاپن حمله کرده‌اند.',
        'genre' => 'اکشن | ماجراجویی | تاریخی',
        'rating' => '9.2/10',
        'story' => [
    ...
    'revill' => [
        ...
        'cover' => 'images/resident-evil-village.jpg',
        'short_description' => 'در فوریه 2021 ایتان وینترز و همسشر میا، توسط کریس ردفیلد به منطقه‌ای در شرق اروپا منتقل شده و زندگی خود را ادامه می‌دهند.',
        'genre' => 'ترسناک | بقا | اکشن',
        'rating' => '9.0/10',
        'story' => [
        ...
        'gallery' => [
            'images/resident-evil-villagess.jpg',
            'images/resident-evil-8-desktop-hd-wallpapers.jpg',
        ],
        'video_link' => '#',
    ],
    'acsha' => [
        ...
        'short_description' => 'داستان بازی Assassin\'s Creed Shadows در ژاپن فئودال قرار دارد ، به طور خاص از سال 1579 در دوره آزوچی مومویاما شروع می شود.',
    ...
    'cyber' => [
        ...
        'short_description' => 'داستان بازی Cyberpunk 2077 در آینده و در شهری پر از جنایت به نام نایت سیتی جریان دارد که شرکت‌های بزرگ فراتر از قانون آن را کنترل می‌کنند.',
        'genre' => 'نقش‌آفرینی | آینده‌نگر',
        'rating' => '8.9/10',
        'story' => [
